...
function loadApp() {
    ...
    if (fileInput.files.length != 0) {
        ...
        reader.addEventListener("load", function () {
            ...
            var algorithm = document.getElementById('form').algorithm.value;
            var delay = parseInt(document.getElementById('form').delay.value);
...
function onLoad(){
    ...
    for(var i =0; i<imagePresets.length; i++){
        ...
        preset.addEventListener('click', function(event){
            ...
            document.getElementById('close-pic').click();
    ...
    var formApp = document.getElementById('form');
...
function resizeCanvas(){
    ...
    var imgWidth = app.img.width;
     var scale = (Math.min(divWidth / imgWidth, divHeight / imgHeight))-0.3;
    // var scale =1;
    console.log(scale);
